...
<body class="theme-red">
                                    ...
                                    <tbody>
										...
										foreach($category as $u){
											echo "<tr>";
												...
												echo "<td><img src='".$u['category_img']."' width='50' height='50' id='catimg'></td>";
	...
	<script type="text/javascript">
			...
			/*var user_id = key;
			var ref = firebase.database().ref('Category' ).child(user_id).remove();
			if(ref){
			...
			window.location.reload();*/
					...
					closeOnConfirm: false
						...
						if(ref){
    							 swal({title: "Deleted!", text: "Category has been deleted.", type: "success"},
                                        function(){ 
                                         location.reload();
                                     }
                                );
		...
		function edit(id){
			 ...
			 $.redirect("category_edit.php",{'id':id},"POST",null,null,true);
