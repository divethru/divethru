...
<head>
    ...
    <title>Tags Edit | DiveThru Admin </title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <form id="form_validation"  >
                                ...
                                <div class="form-group form-float">
									...
									<br>
									<br>
									<input type="text" id="tagscat" class="form-control" value="<?php  echo $Tag["tags_category"];?>" placeholder="Enter Tag category name">
                                ...
                                <div class="form-group form-float">
									...
									<br>
									<br>
									<input type="text" id="tags" class="form-control" data-role="tagsinput" value="<?php echo $Tag["tags"];?>" >
...
//CKEDITOR.replace('ckeditor',config);
	...
	$(".catadd").click(function(){
		...
		//var QRef = firebaseRef.child("DailyQuotes/"+qId);
		...
		updates['/Tags/' + qid] = data;
		firebase.database().ref().update(updates).then(function(snap){
             swal({
                        title: "Updated!",
                        text: "Tag's has been Updated.",
                        html:true,
                        type: "success",
