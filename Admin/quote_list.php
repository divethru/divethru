...
<body class="theme-red">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($DailyQuotes as $d){
                                            echo "<tr>";
                                                echo "<td>".$i."</td>";
                                                echo "<td>".$d['qoute_description']."</td>";
                                                echo "<td>".date("Y-m-d" ,strtotime($d['createdOn']))."</td>"; 
                                                ?>
                                                <td><a href='#' onclick='edit("<?php echo $d['qoute_id'];?>");'><i class="material-icons">mode_edit</i></a> &nbsp;  <a href='#' onclick='del("<?php echo $d['qoute_id'];?>");'><i class="material-icons" style="color:#dc5753;">delete</i></a></td>
    ...
    <script type="text/javascript">
                 ...
                 swal({
                    ...
                    closeOnConfirm: false
                        ...
                        if(ref2){
                            ...
                            swal({title: "Deleted!", text: "Quote has been deleted.", type: "success"},
                                        function(){ 
                                         location.reload();
                                     }
                                );
        ...
        function edit(id){
             ...
             $.redirect("quote_edit.php",{'id':id},"POST",null,null,true);
