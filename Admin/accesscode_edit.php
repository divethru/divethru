...
$acess = get("AccessCodes/".$id);

$SC = explode(",",$acess["category"]);
$SB = explode(",",$acess["bundle"]);
$SS = explode(",",$acess["session"]);
//print_r($SC);
//die;	
...
<head>
    ...
    <title>Access Code Edit | DiveThru Admin </title>
    <!-- Favicon-->
                            ...
                            <form id="form_validation_accesscode"  >
							  ...
							  <div class="form-group form-float">
                                    <div class="form-line error">
                                        <input type="text" class="form-control" id="npromocode" name="npromocode"  aria-invalid="true" value="<?php echo $acess['accesscode'];?>">
								...
								<div class="form-group form-float sub">
                                    <div class="form-line error">
										...
										<select id="access_type" name="access_type" class="form-control show-tick">
                                            <?php 
                                                switch ($acess["accesstype"]) {
                                                    case "friends-family":
                                                        echo '<option value="friends-family" selected>Friends/Family</option><option value="media">Media</option><option value="brandpartnership">Brand Partnership</option><option value="corporate">Corporate</option><option value="influencer">Influencer</option><option value="other">Other</option>'; 
                                                        break;

                                                    case "media":
                                                        echo '<option value="media" selected>Media</option><option value="friends-family">Friends/Family</option><option value="brandpartnership">Brand Partnership</option><option value="corporate">Corporate</option><option value="influencer">Influencer</option><option value="other">Other</option>';
                                                        break;

                                                    case "influencer":
                                                        echo '<option value="influencer" selected>Influencer</option><option value="friends-family">Friends/Family</option><option value="media">Media</option><option value="brandpartnership">Brand Partnership</option><option value="corporate">Corporate</option><option value="other">Other</option>';
                                                        break;

                                                    case "corporate":
                                                       echo '<option value="corporate" selected>Corporate</option><option value="friends-family">Friends/Family</option><option value="media">Media</option><option value="influencer">Influencer</option><option value="brandpartnership">Brand Partnership</option><option value="other">Other</option>';
                                                        break;
                                                    case "brandpartnership":
                                                        echo '<option value="brandpartnership" selected>Brand Partnership</option><option value="friends-family">Friends/Family</option><option value="media">Media</option><option value="influencer">Influencer</option><option value="corporate">Corporate</option><option value="other">Other</option>';
                                                        break;
                                                    case "other":
                                                        echo '<option value="friends-family">Friends/Family</option><option value="media">Media</option><option value="influencer">Influencer</option><option value="corporate">Corporate</option><option value="brandpartnership">Brand Partnership</option><option value="other" selected>Other</option>';
                                                        break;

                                                    default:
                                                   echo '<option value="">-- Access Type --</option><option value="media">Media</option><option value="brandpartnership">Brand Partnership</option><option value="corporate">Corporate</option><option value="influencer">Influencer</option><option value="other">Other</option><option value="friends-family">Friends/Family</option>';                                            
                                                        ;
                                                } 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 " style="margin-bottom:0px;">
                                                <div class="input-group " style="margin-bottom:0px;">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" id="start" name="start" class="form-control" placeholder="Start Date" value="<?php echo $acess['startdate'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 " style="margin-bottom:0px;">
                                                <div class="input-group " style="margin-bottom:0px;">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" id="end" name="end" class="form-control " placeholder="End Date" value="<?php echo $acess['enddate'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
								...
								<div class="form-group form-float">
                                    <div class="form-line error">
                                        <input type="text" class="form-control" id="npeople" name="npeople"  aria-invalid="true" value="<?php echo $acess['maxpeopleallowed'];?>" >
                                        <label class="form-label">Max Allowed People</label>
                                    </div>
                               </div>
								...
								<div class="form-group form-float sub">
                                    <div class="form-line error">
										...
										<select id="access_to" name="access_to" class="form-control show-tick">
                                            ...
                                            <?php
                                                foreach($C as $ck => $cv){
                                                    if($ck == $access["accessto"]){
                                                    echo '<option value="'.$ck.'" selected>'.$ck.'</option>';
                                            ...
                                            if($acess["accessto"] == "custom"){

                                                     echo '<option value="custom" selected>Custom</option><option value="all">All</option>';
                                                }else if($acess["accessto"] == "all"){

                                                     echo '<option value="all" selected>All</option><option value="custom">Custom</option>';
                                                }
                                            ?>
										</select>
                                    </div>
							  ...
							  <div class="form-group form-float customselect" style="display:none;">
                                    <fieldset style="border:1px solid #e5e5e5;!important;">
										...
										foreach($C as $ck => $cv){
											...
											echo '<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><div class="card"><div class="header"><h2><input type="checkbox" id="'.$ck.'" class="catsel filled-in" name="checkbox" value="'.$ck.'" checked><label for="'.$ck.'" style="width:200px;">'.$ck.'</label></h2></div><div class="body" style="max-height:300px;overflow-y:scroll;">';
											}else if(!in_array($ck,$SC)){
											...
											foreach($cv as $key => $val){
													if($val["type"] == "Bundle" && in_array($val["id"],$SB)){
														
														echo '<input type="checkbox" id="'.$ck.$key.'" class="selsingle filled-in" data-type="'.$val["type"].'" name="checkbox" value="'.$val["id"].'" checked><label for="'.$ck.$key.'" style="width:200px;">'.$val["name"].'</label>';
													}else if($val["type"] == "Bundle" && !in_array($val["id"],$SB)){
													...
													if($val["type"] == "Session" && in_array($val["id"],$SS)){
														
														echo '<input type="checkbox" id="'.$ck.$key.'" class="selsingle filled-in" data-type="'.$val["type"].'" name="checkbox" value="'.$val["id"].'" checked><label for="'.$ck.$key.'" style="width:200px;">'.$val["name"].'</label>';
													}else if($val["type"] == "Session" && !in_array($val["id"],$SS)){
   ...
   <!-- Jquery Datetime Plugin Js -->
	...
	<script type="text/javascript">
		...
		$(function () {
            ...
            var old = $("#oldsdate").val();
            var eold = $("#oldedate").val();
            var m1 = moment(old).format("dddd DD MMMM YYYY");
            var m2 = moment(eold).format("dddd DD MMMM YYYY");
            $("#start").val(m1);
            $("#end").val(m2);

            var sdt = new Date(old);
            var edt = new Date(eold);
...
//CKEDITOR.replace('ckeditor',config);
	...
	$(".codeadd").click(function(){
		...
		if(temp == true){
                ...
                catRef.child(id).once('value').then(function(snap) {   
                                ...
                                data.maxpeopleallowed = Npeople;
                                data.startdate = startdate;
                                data.enddate = enddate;
                                data.accesstype = accesstype;
                                data.accessto = accessto;
                                data.category = Scat.toString();
                                data.bundle = SBundle.toString();
                                data.session = SSession.toString();
                             ...
                             return firebaseRef.child("AccessCodes").update(update).then(function(snap){
                        
                                    swal({
                                            title: "Updated!",
                                            text: "Access Code has been Updated.",
                                            html:true,
                                            type: "success",
                		...
                		// catRef.child(id).update({
                		// 	accesscode: code,
                		// 	nopeopleusing: Npeople,
                		// 	nopeopleused: 0,
