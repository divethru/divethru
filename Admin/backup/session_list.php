                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
										...
										foreach($session as $u){
											echo "<tr>";
												echo "<td>".$u['session_name']."</td>";
												echo "<td>".$u['session_description']."</td>";
												echo "<td>".$u['session_subcription_type']."</td>";
												echo "<td><img src='".$u['session_img']."' width='50' height='50' id='simg'></td>";
											
												?>
												
												<td><a href='session_edit.php?id=<?php echo $u['session_id']?>'><i class="material-icons">mode_edit</i></a> &nbsp;  <a href='#' onclick='del("<?php echo $u['session_id'];?>");'><i class="material-icons" style="color:#dc5753;">delete</i></a></td>
												<?php 
											echo "</tr>";
