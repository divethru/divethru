...
<body class="theme-red">
										...
										if(count($subcategory)>0)
										{
											foreach($subcategory as $u){
												echo "<tr>";
													...
													echo "<td>".$u['parentcategory_id']."</td>";
													echo "<td><img src='".$u['subcategory_img']."' width='50' height='50' id='catimg'></td>";
												
													?>
													
													<td><a href='subcategory_edit.php?id=<?php echo $u['subcategory_id']?>'><i class="material-icons">mode_edit</i></a> &nbsp;  <a href='#' onclick='del("<?php echo $u['subcategory_id'];?>");'><i class="material-icons" style="color:#dc5753;">delete</i></a></td>
													<?php 
												echo "</tr>";
											}
										}
	...
	<script type="text/javascript">
			...
			var id = key;
			var ref = firebase.database().ref().child('/subcategory/' + id).remove();
			if(ref){
				
						alert('This SubCategory Deleted Sucessfully');
			}
