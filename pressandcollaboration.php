...
.slide p {font-size:14px !important;}}
  ...
  <body style="padding-top: 118px;">
       ...
       <div class="container-fluid py-5 text-center" style="background-color: #f3f3f3;">
    <div class="container">
	     
		<div class="row maditation justify-content-center">
		      <div class="col-lg px-0 text-center text-lg-left">
		...
		<div class="row more justify-content-center">
		     <a href="#" class="mt-5 mb-3"><u>M O R E &nbsp; P R E S S &nbsp; R E A L E S E S</u></a>
		</div>
...
<!--WORD FOR SHOPIN-->
	...
	<div class="container word text-center pt-5 pb-5">
	     <h2 class="mb-0">Meditation for Kids</h2>
...
<div class="container-fluid">
     <div class="container">
	         <div class="row">
		 <div class="col-8 col-md-4 py-auto text-center mx-auto">
                              ...
                              <br><br>
                               ...
                               <br><br>
                                ...
                                <img src="img/app atore.png" class="img-responsive plystr mt-3 mt-md-0" height="40" width="140"> 
                                 <img src="img/google play.png"  class="img-responsive plystr1 mt-3 mt-md-0"  height="40" width="140"  ></div>
                                 <br><br>
                            </div>
